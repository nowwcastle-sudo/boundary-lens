...
Assert-DocumentationContract ($readme -match 'releases/tag/v0\.2\.0-experimental\.2') 'README exact release metadata'
...
Assert-DocumentationContract ($readme.Contains('$expectedMembers = @(''BoundaryLens.ps1'', ''BoundaryIncident.ps1'', ''IncidentInput.psm1'', ''IncidentObservations.psm1'', ''IncidentHandoff.psm1'', ''LICENSE'', ''README.md'', ''SHA256SUMS.txt'')')) 'README current-release eight-member contract'
Assert-DocumentationContract ($readme.Contains('if ($sums.Count -ne 7)')) 'README current-release seven-checksum contract'
Assert-DocumentationContract ($readme.Contains('(BoundaryLens\.ps1|BoundaryIncident\.ps1|IncidentInput\.psm1|IncidentObservations\.psm1|IncidentHandoff\.psm1|LICENSE|README\.md)')) 'README current-release checksum allowlist'
